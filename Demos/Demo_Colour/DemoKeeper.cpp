...
namespace demo
{
	...
	void DemoKeeper::createScene()
	{
		...
		base::BaseManager::getInstance().setDescriptionText("Sample colour picker implementation. Select text in Edit and then select colour to colour selected part of text.");
