...
namespace demo
{
	...
	void DemoKeeper::createScene()
	{
		...
		root.at(0)->findWidget("Text")->castType<MyGUI::TextBox>()->setCaption("Sample colour picker implementation. Select text in Edit and then select colour to colour selected part of text.");
