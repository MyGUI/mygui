...
namespace demo
{
	...
	void DemoKeeper::createScene()
	{
		...
		if (root.size() == 1)
			root.at(0)->findWidget("Text")->castType<MyGUI::TextBox>()->setCaption("Msdf font, that can be scaled and rendered with a high quality, while single small texture is used for all sizes. Small-size fonts are still better with a regular texture.");

		MyGUI::Button* button1 = MyGUI::Gui::getInstance().createWidget<MyGUI::Button>("Button", MyGUI::IntCoord(110, 10, 200, 50), MyGUI::Align::Default, "Main");
		...
		MyGUI::Button* button2 = MyGUI::Gui::getInstance().createWidget<MyGUI::Button>("Button", MyGUI::IntCoord(320, 10, 200, 50), MyGUI::Align::Default, "Main");
		...
		MyGUI::ImageBox* fontTexture = MyGUI::Gui::getInstance().createWidget<MyGUI::ImageBox>("ImageBox", MyGUI::IntCoord(110, 70, 256, 256), MyGUI::Align::Default, "Back");
		fontTexture->setImageTexture("MsdfFont.png");

		int index = 0;
		{
			const MyGUI::VectorWidgetPtr& widgets = MyGUI::LayoutManager::getInstance().loadLayout("EditPanel.layout", "4");
		...
		{
			const MyGUI::VectorWidgetPtr& widgets = MyGUI::LayoutManager::getInstance().loadLayout("EditPanel.layout", "0");
		...
		{
			const MyGUI::VectorWidgetPtr& widgets = MyGUI::LayoutManager::getInstance().loadLayout("EditPanel.layout", "1");
		...
		{
			const MyGUI::VectorWidgetPtr& widgets = MyGUI::LayoutManager::getInstance().loadLayout("EditPanel.layout", "2");
		...
		{
			const MyGUI::VectorWidgetPtr& widgets = MyGUI::LayoutManager::getInstance().loadLayout("EditPanel.layout", "3");
