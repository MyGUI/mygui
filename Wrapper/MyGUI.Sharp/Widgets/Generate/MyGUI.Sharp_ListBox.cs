    ...
    public  class ListBox : Widget
    {
		...
		private struct ExportEventListChangeScroll
		{
			...
			public delegate void ExportHandle(
				[MarshalAs(UnmanagedType.Interface)]  ListBox _sender ,
				  uint _position );
		...
		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
		private static extern void ExportListBox_SetProperty_key_value( IntPtr _native ,
		...
		public void SetProperty(
			...
			string _value )
		{
			ExportListBox_SetProperty_key_value( mNative , 
				 _key ,
				 _value );
		}
