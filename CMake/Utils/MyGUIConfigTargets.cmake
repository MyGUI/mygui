...
function(mygui_install_target TARGETNAME)
	install(TARGETS ${TARGETNAME}
		...
		LIBRARY DESTINATION "${CMAKE_INSTALL_LIBDIR}${MYGUI_LIB_RELEASE_PATH} CONFIGURATIONS Release None ""
		ARCHIVE DESTINATION "${CMAKE_INSTALL_LIBDIR}${MYGUI_LIB_RELEASE_PATH} CONFIGURATIONS Release None ""
	...
	install(TARGETS ${TARGETNAME}
		...
		LIBRARY DESTINATION "${CMAKE_INSTALL_LIBDIR}${MYGUI_LIB_RELWDBG_PATH} CONFIGURATIONS RelWithDebInfo
		ARCHIVE DESTINATION "${CMAKE_INSTALL_LIBDIR}${MYGUI_LIB_RELWDBG_PATH} CONFIGURATIONS RelWithDebInfo
	...
	install(TARGETS ${TARGETNAME}
		...
		LIBRARY DESTINATION "${CMAKE_INSTALL_LIBDIR}${MYGUI_LIB_MINSIZE_PATH} CONFIGURATIONS MinSizeRel
		ARCHIVE DESTINATION "${CMAKE_INSTALL_LIBDIR}${MYGUI_LIB_MINSIZE_PATH} CONFIGURATIONS MinSizeRel
	...
	install(TARGETS ${TARGETNAME}
		...
		LIBRARY DESTINATION "${CMAKE_INSTALL_LIBDIR}${MYGUI_LIB_DEBUG_PATH} CONFIGURATIONS Debug
		ARCHIVE DESTINATION "${CMAKE_INSTALL_LIBDIR}${MYGUI_LIB_DEBUG_PATH} CONFIGURATIONS Debug
