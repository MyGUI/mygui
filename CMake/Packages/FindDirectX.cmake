...
if(WIN32) # The only platform it makes sense to check for DirectX SDK
	...
	if(MSVC AND NOT MSVC90)
		...
		if(EXISTS "${_kit10_dir}/Include")
			file(
				GLOB _w10_versions
				RELATIVE ${_kit10_dir}/Include
				${_kit10_dir}/Include/10.*
			)
			list(
				APPEND _w10_versions
				"10.0.10240.0"
				"10.0.14393.0"
				"10.0.15063.0"
				"10.0.16299.0"
	...
	if(DirectX_D3D11_INCLUDE_DIR AND DirectX_D3D11_LIBRARY)
		...
		if(DirectX_DXGI_LIBRARY AND NOT TARGET DirectX11::DXGI)
			...
			set_target_properties(
				DirectX11::DXGI
				PROPERTIES INTERFACE_LINK_LIBRARIES "${DirectX_DXGI_LIBRARY}"
			)
		endif()
		if(DirectX_DXGUID_LIBRARY AND NOT TARGET DirectX11::DXGUID)
			...
			set_target_properties(
				DirectX11::DXGUID
				PROPERTIES INTERFACE_LINK_LIBRARIES "${DirectX_DXGUID_LIBRARY}"
			)
		endif()
		if(DirectX_D3DCOMPILER_LIBRARY AND NOT TARGET DirectX11::D3DCompiler)
			...
			set_target_properties(
				...
				PROPERTIES INTERFACE_LINK_LIBRARIES "${DirectX_D3DCOMPILER_LIBRARY}"
			)
		endif()
	endif()
	...
	find_library(
		...
		PATH_SUFFIXES ${DirectX_LIBPATH_SUFFIX}
	)
	find_library(
