...
if (MYGUI_STANDALONE_BUILD)
	SET(OGRE_INCLUDE_DIR "C:\MYGUIHACK OGRE_HOME MYGUIBRACKETHACK/include" "C:\MYGUIHACK OGRE_SRC MYGUIBRACKETHACK/OgreMain/include" CACHE STRING "")
	SET(OGRE_LIBRARIES "debug;OgreMain_d;optimized;OgreMain" CACHE STRING "")
	SET(OGRE_LIB_DIR "C:\MYGUIHACK OGRE_HOME MYGUIBRACKETHACK/lib" "C:\MYGUIHACK OGRE_SRC MYGUIBRACKETHACK/lib" CACHE STRING "")
	SET(OGRE_FOUND TRUE)
else()
	IF (NOT OGRE_DIR)
...
set(OGRE_PREFIX_PATH
  ${OGRE_DIR} ${OGRE_HOME} ${OGRE_SDK} ${ENV_OGRE_HOME} ${ENV_OGRE_SDK}
  ${OGRE_PREFIX_GUESSES}
)
create_search_paths(OGRE)
# If both OGRE_BUILD and OGRE_SOURCE are set, prepare to find Ogre in a build dir
set(OGRE_PREFIX_SOURCE ${OGRE_DIR} ${OGRE_SOURCE} ${ENV_OGRE_SOURCE})
set(OGRE_PREFIX_BUILD ${OGRE_DIR} ${OGRE_BUILD} ${ENV_OGRE_BUILD})
