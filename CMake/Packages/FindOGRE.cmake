...
if (MYGUI_STANDALONE_BUILD)
	SET(OGRE_INCLUDE_DIR AAAMYGUIHACK$(OGRE_HOME)/includeAAA AAAMYGUIHACK$(OGRE_SRC)/OgreMain/includeAAA CACHE STRING "")
	SET(OGRE_LIBRARIES "debug;OgreMain_d;optimized;OgreMain" CACHE STRING "")
	SET(OGRE_LIB_DIR AAAMYGUIHACK$(OGRE_HOME)/libAAAMYGUIHACK AAAMYGUIHACK$(OGRE_SRC)/libAAAMYGUIHACK CACHE STRING "")
	SET(OGRE_FOUND TRUE)
else()
