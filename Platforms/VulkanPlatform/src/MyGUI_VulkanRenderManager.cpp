...
namespace MyGUI
{
	namespace
	{
			...
			VkImageLayout _newLayout)
		{
			...
			// Even a discarded image may still have earlier readers or RTT writers.
			// Shader-read layout can follow either an upload or a render-pass write.
			...
			barrier.dstAccessMask = _newLayout == VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL
