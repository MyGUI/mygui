...
namespace MyGUI
{
	...
	std::filesystem::path OpenGLESDataManager::findDataPath(const std::string& _name) const
	{
		common::VectorPath paths;
	...
	void OpenGLESDataManager::addResourceLocation(const std::filesystem::path& _name, bool _recursive)
	{
