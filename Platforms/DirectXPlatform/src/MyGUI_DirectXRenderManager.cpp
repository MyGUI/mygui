...
namespace MyGUI
{
	...
	void DirectXRenderManager::begin()
	{
		...
		mpD3DDevice->SetRenderState(D3DRS_SEPARATEALPHABLENDENABLE, TRUE);
		mpD3DDevice->SetRenderState(D3DRS_SRCBLENDALPHA, D3DBLEND_ONE);
		mpD3DDevice->SetRenderState(D3DRS_DESTBLENDALPHA, D3DBLEND_INVSRCALPHA);
