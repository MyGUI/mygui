...
namespace MyGUI
{
	...
	std::filesystem::path OpenGL3DataManager::findDataPath(const std::string& _name) const
	{
		common::VectorPath paths;
	...
	void OpenGL3DataManager::addResourceLocation(const std::filesystem::path& _name, bool _recursive)
	{
