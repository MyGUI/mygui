...
namespace MyGUI
{
	namespace factory
	{
		...
		public:
			...
			// методы для парсинга
			void Combo_ModeDrop(WidgetPtr _widget, const Ogre::String &_key, const Ogre::String &_value);
			void Combo_AddString(WidgetPtr _widget, const Ogre::String &_key, const Ogre::String &_value);
		};
