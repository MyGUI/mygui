...
namespace MyGUI
{
	namespace factory
	{
		...
		public:
			...
			void Window_MinSize(WidgetPtr _widget, const Ogre::String &_key, const Ogre::String &_value);
			void Window_MaxSize(WidgetPtr _widget, const Ogre::String &_key, const Ogre::String &_value);
