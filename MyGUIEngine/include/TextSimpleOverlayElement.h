#ifndef __TEXT_SIMPLE_OVERLAY_ELEMENT_H__
#define __TEXT_SIMPLE_OVERLAY_ELEMENT_H__
		...
		void setFontName( const Ogre::String& font )
		{
			...
			if (mpFont.isNull())
				MYGUI_EXCEPT( Ogre::Exception::ERR_ITEM_NOT_FOUND,
					"Could not find font " + font, "TextAreaOverlayElement::setFontName" );
			mpFont->load();
...
#endif // __TEXT_SIMPLE_OVERLAY_ELEMENT_H__
