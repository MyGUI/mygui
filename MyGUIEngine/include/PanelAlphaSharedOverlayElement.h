#ifndef _PANELALPHASHAREDOVERLAYELEMENT_H_
#define _PANELALPHASHAREDOVERLAYELEMENT_H_
...
namespace MyGUI
{
	...
	class _MyGUIExport PanelAlphaSharedOverlayElement : public PanelOverlayElement
	{
	protected:
		// цвет вершины
		Ogre::uint32 m_color;
	...
	public:
		...
		PanelAlphaSharedOverlayElement(const String& name) :
...
//					HardwareBuffer::HBU_STATIC_WRITE_ONLY // mostly static except during resizing
	...
	}; // class PanelAlphaSharedOverlayElement : public PanelOverlayElement

} // namespace MyGUI

#endif // _PANELALPHASHAREDOVERLAYELEMENT_H_
