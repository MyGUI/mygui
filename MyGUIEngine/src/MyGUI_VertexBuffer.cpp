...
namespace MyGUI
{
	...
	void VertexBuffer::initRenderState()
	{
		// set-up matrices
	...
	void VertexBuffer::resizeVertexBuffer()
	{
	...
	void VertexBuffer::setVertextCount(size_t _count)
	{
		mNeedVertexCount = _count;
	}

	size_t VertexBuffer::getVertextCount()
	{
	...
	void VertexBuffer::unlock(size_t _count)
	{
		mRenderOperation.vertexData->vertexCount = _count;
		mVertexBuffer->unlock();
	}

	void VertexBuffer::render(const std::string& _texture)
	{
