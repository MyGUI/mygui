...
namespace MyGUI
{
	namespace factory
	{
		...
		WidgetPtr ProgressFactory::createWidget(const Ogre::String& _skin, const IntCoord& _coord, Align _align, CroppedRectanglePtr _parent, const Ogre::String& _name)
		{
			return new Progress(_coord, _align, SkinManager::getInstance().getSkin(_skin), _parent, _name);
		}
