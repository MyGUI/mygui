...
void DemoKeeper::start()
{
	...
	/*mItemBoxV.addItem(new ItemData(TypeCloth, 5, L"Ïîëîòíî", L"îïèñàíèå Ïîëîòíî"));
	mItemBoxV.addItem(new ItemData(TypeTear, 5, L"Ñëåçà", L"îïèñàíèå Ñëåçà"));
	mItemBoxV.addItem(new ItemData(TypeEye, 5, L"Ãëàç", L"îïèñàíèå Ãëàç"));
	mItemBoxV.addItem(new ItemData(TypeEmerald, 5, L"Èçóìðóä", L"îïèñàíèå Èçóìðóä"));
	mItemBoxV.addItem(new ItemData(TypeWings, 5, L"Êðûëüÿ", L"îïèñàíèå Êðûëüÿ"));
	mItemBoxV.addItem(new ItemData(TypeIce, 5, L"Ëåä", L"îïèñàíèå Ëåä"));
	mItemBoxV.addItem(new ItemData(TypeBoard, 5, L"Ùèò", L"îïèñàíèå Ùèò"));
	mItemBoxV.addItem(new ItemData(TypeBoots, 5, L"Ñàïîãè", L"îïèñàíèå Ñàïîãè"));
	...
	mItemBoxH.addItem(new ItemData(TypeRoll, 5, L"Ñâèòîê", L"îïèñàíèå Ñâèòîê"));
	mItemBoxH.addItem(new ItemData(TypeCloth, 5, L"Ïîëîòíî", L"îïèñàíèå Ïîëîòíî"));
	mItemBoxH.addItem(new ItemData(TypeTear, 5, L"Ñëåçà", L"îïèñàíèå Ñëåçà"));
	mItemBoxH.addItem(new ItemData(TypeEye, 5, L"Ãëàç", L"îïèñàíèå Ãëàç"));
	mItemBoxH.addItem(new ItemData(TypeEmerald, 5, L"Èçóìðóä", L"îïèñàíèå Èçóìðóä"));
	mItemBoxH.addItem(new ItemData(TypeWings, 5, L"Êðûëüÿ", L"îïèñàíèå Êðûëüÿ"));
	mItemBoxH.addItem(new ItemData(TypeIce, 5, L"Ëåä", L"îïèñàíèå Ëåä"));
	mItemBoxH.addItem(new ItemData(TypeBoard, 5, L"Ùèò", L"îïèñàíèå Ùèò"));
	mItemBoxH.addItem(new ItemData(TypeBoots, 5, L"Ñàïîãè", L"îïèñàíèå Ñàïîãè"));
	...
	ItemData data(TypeEmerald, 5, L"Èçóìðóä", L"îïèñàíèå Èçóìðóä");
