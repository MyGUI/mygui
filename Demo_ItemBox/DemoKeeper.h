...
private:
	...
	void notifyDropState(ItemBoxVLayout * _sender, MyGUI::DropState _state);

	void notifyToolTip(ItemBoxVLayout * _sender, const MyGUI::ToolTipInfo & _info, ItemData * _data);
