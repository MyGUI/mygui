...
namespace sigslot
{
	...
	public:
		...
		{
			lock_block<mt_policy> lock(this);
			typename connections_list::const_iterator itNext, it = base_type::m_connected_slots.begin();
			typename connections_list::const_iterator itEnd = base_type::m_connected_slots.end();
