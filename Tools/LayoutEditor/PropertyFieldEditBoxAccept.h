/*!
	...
	@date		12/2010
*/
#ifndef __PROPERTY_FIELD_EDIT_BOX_ACCEPT_H__
#define __PROPERTY_FIELD_EDIT_BOX_ACCEPT_H__
...
namespace tools
{
	class PropertyFieldEditBoxAccept :
		public IPropertyField
	{
	public:
		PropertyFieldEditBoxAccept();
		virtual ~PropertyFieldEditBoxAccept();
...
#endif // __PROPERTY_FIELD_EDIT_BOX_ACCEPT_H__
