...
/*void BasisManager::createInput() // создаем систему ввода
{
	...
	//SetWindowLong((HWND)windowHnd, GWL_WNDPROC, (long)MyWindowProc); // «адаЄм новый адрес 'оконной процедуры' и присваеваем новый адрес уже 'оконной процедуры' глобальной переменной.
