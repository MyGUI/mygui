...
namespace MyGUI
{
	namespace Managed
	{
		...
		template <> struct Convert<MyGUI::FlowDirection>
		{
			...
			inline static const FlowDirection& To(const MyGUI::FlowDirection& _value) { return reinterpret_cast<const FlowDirection&>(_value); }
			inline static MyGUI::FlowDirection& From(FlowDirection& _value) { return reinterpret_cast<MyGUI::FlowDirection&>(_value); }
		};
