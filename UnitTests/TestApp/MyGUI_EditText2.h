...
*/
#ifndef __MYGUI_EDIT_TEXT2_H__
#define __MYGUI_EDIT_TEXT2_H__
...
namespace MyGUI
{
	...
	class /*MYGUI_EXPORT */EditText2 : public ISubWidgetText
	{
		MYGUI_RTTI_DERIVED( EditText2 );
	...
	protected:
		...
		demo::TextView mTextView;
	};

} // namespace MyGUI

#endif // __MYGUI_EDIT_TEXT2_H__
