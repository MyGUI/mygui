...
namespace widget
{
	...
	SimpleText ::SimpleText (int _x, int _y, int _cx, int _cy, char _align, SubWidget * _parent) : 
...
/*		Ogre::OverlayManager &overlayManager = Ogre::OverlayManager::getSingleton();
	...
	void SimpleText ::align(int _cx, int _cy, bool _update)
	{
...
//		m_overlayContainer->setDimensions(m_cx, m_cy);
	...
	void SimpleText ::align(int _x, int _y, int _cx, int _cy, bool _update)
	{
...
//		m_overlayContainer->setUV(UV_lft_total, UV_top_total, UV_rgt_total, UV_btm_total);
	...
	void SimpleText ::show(bool _show)
	{
...
//		_show ? m_overlayContainer->show() : m_overlayContainer->hide();
	...
	void SimpleText ::attach(Ogre::OverlayElement * _element)
	{
