...
namespace MyGUI.Sharp
{
    ...
    public partial class Widget : BaseWidget
    {
		...
		//InsertPoint
   		...
   		#region Method UpdateArrange

		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
		private static extern void ExportWidget_UpdateArrange_coordPlace_oldsize( IntPtr _native ,
			[In] ref IntCoord _coordPlace ,
			 ref IntSize _oldsize );

		public void UpdateArrange(
			IntCoord _coordPlace ,
			IntSize _oldsize )
		{
			ExportWidget_UpdateArrange_coordPlace_oldsize( mNative , 
				ref _coordPlace ,
				ref _oldsize );
		}
   		...
   		#region Method GetPaddingHeight

		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
        
		private static extern int ExportWidget_GetPaddingHeight( IntPtr _native );

		public int GetPaddingHeight( )
		{
			return  ExportWidget_GetPaddingHeight( mNative )  ;
		}
   		...
   		#region Method GetPaddingWidth

		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
        
		private static extern int ExportWidget_GetPaddingWidth( IntPtr _native );

		public int GetPaddingWidth( )
		{
			return  ExportWidget_GetPaddingWidth( mNative )  ;
		}
   		...
   		#region Method GetMarginHeight

		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
        
		private static extern int ExportWidget_GetMarginHeight( IntPtr _native );

		public int GetMarginHeight( )
		{
			return  ExportWidget_GetMarginHeight( mNative )  ;
		}
   		...
   		#region Method GetMarginWidth

		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
        
		private static extern int ExportWidget_GetMarginWidth( IntPtr _native );

		public int GetMarginWidth( )
		{
			return  ExportWidget_GetMarginWidth( mNative )  ;
		}
   		...
   		#region Method GetDesiredSize

		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
        
		private static extern IntPtr ExportWidget_GetDesiredSize( IntPtr _native );

		public IntSize GetDesiredSize( )
		{
			return  (IntSize)Marshal.PtrToStructure(  ExportWidget_GetDesiredSize( mNative )  , typeof(IntSize) )  ;
		}
   		...
   		#region Method UpdateMeasure

		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
		private static extern void ExportWidget_UpdateMeasure_sizeAvailable( IntPtr _native ,
			 ref IntSize _sizeAvailable );

		public void UpdateMeasure(
			IntSize _sizeAvailable )
		{
			ExportWidget_UpdateMeasure_sizeAvailable( mNative , 
				ref _sizeAvailable );
		}
   		...
   		#region Method InvalidateMeasure

		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
		private static extern void ExportWidget_InvalidateMeasure( IntPtr _native );

		public void InvalidateMeasure( )
		{
			ExportWidget_InvalidateMeasure(  mNative );
		}
		...
		public IntSize GetParentSize( )
		{
   		...
   		#region Method GetVisualParent

		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.Interface)]
		private static extern Widget ExportWidget_GetVisualParent( IntPtr _native );

		public Widget GetVisualParent( )
		{
			return  ExportWidget_GetVisualParent( mNative )  ;
		}
			...
			string _value )
		{
   		...
   		#region Property SizePolicy

		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I4)]
		private static extern SizePolicy ExportWidget_GetSizePolicy( IntPtr _widget );
		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
		private static extern void ExportWidget_SetSizePolicy( IntPtr _widget, [MarshalAs(UnmanagedType.I4)]  SizePolicy _value );

		public SizePolicy SizePolicy
		{
			get { return  ExportWidget_GetSizePolicy( mNative )  ; }
			set { ExportWidget_SetSizePolicy( mNative,  value ); }
		}
		...
		private static extern IntPtr ExportWidget_GetMaxSize( IntPtr _widget );
		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
		private static extern void ExportWidget_SetMaxSize( IntPtr _widget,  ref IntSize _value );

		public IntSize MaxSize
		{
			get { return  (IntSize)Marshal.PtrToStructure(  ExportWidget_GetMaxSize( mNative )  , typeof(IntSize) )  ; }
			set { ExportWidget_SetMaxSize( mNative, ref value ); }
		}
		...
		private static extern IntPtr ExportWidget_GetMinSize( IntPtr _widget );
		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
		private static extern void ExportWidget_SetMinSize( IntPtr _widget,  ref IntSize _value );

		public IntSize MinSize
		{
			get { return  (IntSize)Marshal.PtrToStructure(  ExportWidget_GetMinSize( mNative )  , typeof(IntSize) )  ; }
			set { ExportWidget_SetMinSize( mNative, ref value ); }
		}
		...
		private static extern IntPtr ExportWidget_GetPadding( IntPtr _widget );
		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
		private static extern void ExportWidget_SetPadding( IntPtr _widget, [In] ref IntRect _value );

		public IntRect Padding
		{
			get { return  (IntRect)Marshal.PtrToStructure(  ExportWidget_GetPadding( mNative )  , typeof(IntRect) )  ; }
			set { ExportWidget_SetPadding( mNative, ref value ); }
		}
		...
		private static extern IntPtr ExportWidget_GetMargin( IntPtr _widget );
		[DllImport("MyGUI.Export.dll", CallingConvention = CallingConvention.Cdecl)]
		private static extern void ExportWidget_SetMargin( IntPtr _widget, [In] ref IntRect _value );

		public IntRect Margin
		{
			get { return  (IntRect)Marshal.PtrToStructure(  ExportWidget_GetMargin( mNative )  , typeof(IntRect) )  ; }
			set { ExportWidget_SetMargin( mNative, ref value ); }
		}
