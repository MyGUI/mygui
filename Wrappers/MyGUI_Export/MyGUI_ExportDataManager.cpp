...
namespace MyGUI
{
	...
	std::filesystem::path ExportDataManager::findDataPath(const std::string& _name) const
	{
		common::VectorPath paths;
	...
	void ExportDataManager::addResourceLocation(const std::filesystem::path& _name, bool _recursive)
	{
