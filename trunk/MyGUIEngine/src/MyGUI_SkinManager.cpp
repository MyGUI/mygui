...
namespace MyGUI
{
	...
	{
		// вспомогательный класс дл€ биндинга сабскинов
		SubWidgetBinding bind;

		// берем детей и крутимс€, основной цикл со скинами
		...
		while (skin.nextNode(XML_TYPE)) {
			...
			// берем детей и крутимс€, цикл с саб скинами
			...
			while (basis.nextNode()) {
				...
				if (basis->getName() == "Property") {
					...
					// берем детей и крутимс€, цикл со стейтами
