...
namespace MyGUI
{
	...
	public:
		...
		virtual StateInfo * createData(xml::xmlNodePtr _node, xml::xmlNodePtr _root, Version _version) = 0;
	};
	...
	public:
		...
		virtual StateInfo * createData(xml::xmlNodePtr _node, xml::xmlNodePtr _root, Version _version)
		{
