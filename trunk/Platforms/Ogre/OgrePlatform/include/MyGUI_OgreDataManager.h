...
namespace MyGUI
{
	...
	public:
		...
		static OgreDataManager& getInstance() { return static_cast<OgreDataManager&>(Singleton<DataManager>::getInstance()); }
		static OgreDataManager* getInstancePtr() { return static_cast<OgreDataManager*>(Singleton<DataManager>::getInstancePtr()); }
