...
namespace MyGUI
{
	...
	public:
		...
		static DirectXRenderManager& getInstance() { return *getInstancePtr(); }
		static DirectXRenderManager* getInstancePtr() { return static_cast<DirectXRenderManager*>(RenderManager::getInstancePtr()); }
