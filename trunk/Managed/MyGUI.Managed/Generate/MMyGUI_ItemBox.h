...
namespace MyGUI
{
	...
	public:
		delegate void HandleDrawItem( Convert<MyGUI::ItemBox *>::Type _sender, Convert<MyGUI::Widget *>::Type _item, Convert<const MyGUI::IBDrawItemInfo &>::Type _info );
			...
			void add(HandleDrawItem^ _value)
			{
				...
				static_cast<ThisType*>(mNative)->requestDrawItem =
					static_cast< MyGUI::delegates::IDelegate3< MyGUI::ItemBox *, MyGUI::Widget *, const MyGUI::IBDrawItemInfo & > *>(
						new Delegate3< HandleDrawItem^, MyGUI::ItemBox *, MyGUI::Widget *, const MyGUI::IBDrawItemInfo & >(mDelegateDrawItem) );
			}
	...
	public:
		delegate void HandleCoordItem( Convert<MyGUI::ItemBox *>::Type _sender, Convert<MyGUI::types::TCoord< int > &>::Type _coord, Convert<bool>::Type _drag );
			...
			void add(HandleCoordItem^ _value)
			{
				...
				static_cast<ThisType*>(mNative)->requestCoordItem =
					static_cast< MyGUI::delegates::IDelegate3< MyGUI::ItemBox *, MyGUI::types::TCoord< int > &, bool > *>(
						new Delegate3< HandleCoordItem^, MyGUI::ItemBox *, MyGUI::types::TCoord< int > &, bool >(mDelegateCoordItem) );
			}
