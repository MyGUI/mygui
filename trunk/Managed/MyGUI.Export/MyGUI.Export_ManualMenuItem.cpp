...
namespace Export
{
	...
	namespace ScopeMenuItemProperty_ItemData
	{
		...
		MYGUIEXPORT void MYGUICALL ExportMenuItem_SetItemData( MyGUI::Widget* _native , Convert<MyGUI::Any>::Type _value )
		{
			static_cast< MyGUI::MenuItem * >(_native)->setItemData( Convert<MyGUI::Any>::From( _value ) );
		}
	}
