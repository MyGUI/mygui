...
namespace MyGUI
{
	...
	void OgreDataManager::initialise()
	{
	}
	...
	Data* OgreDataManager::getData(const std::string& _name, const std::string& _group)
	{
		try
		{
			Ogre::DataStreamPtr stream = Ogre::ResourceGroupManager::getSingleton().openResource(_name, _group);
