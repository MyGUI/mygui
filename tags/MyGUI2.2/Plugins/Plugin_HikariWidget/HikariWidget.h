...
namespace Hikari
{
	...
	public:
		...
		*	\endcode
		*/
		void bind(const Ogre::UTFString& funcName, FlashDelegate::IDelegate* callback);
		...
		*/
		void unbind(const Ogre::UTFString& funcName);
		...
		*/
		...
		FlashValue callFunction(Ogre::UTFString funcName, const Arguments& args = Args());

	protected:
		HikariWidget(MyGUI::WidgetStyle _style, const MyGUI::IntCoord& _coord, MyGUI::Align _align, const MyGUI::WidgetSkinInfoPtr _info, MyGUI::WidgetPtr _parent, MyGUI::ICroppedRectangle * _croppedParent, MyGUI::IWidgetCreator * _creator, const std::string& _name);
